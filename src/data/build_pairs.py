...
from AEGIS 2.0 and HarmBench for RQ3 (contrastive/fine-tuning) experiments.
...
Sizes are fixed via CLI defaults (documented in data/README.md) so every run
of this script with the default seed reproduces the same dataset sizes.
"""
