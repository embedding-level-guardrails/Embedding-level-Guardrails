...
| [`rq4_training_pairs`](rq4_training_pairs) | RQ4 | Сбор пар для обучения (safe/harm contrast, paraphrase, jailbreak variant) из AEGIS + HarmBench | — | done |
| [`common`](common) | — | Переиспользуемый код между направлениями | — | пусто |

Ветки/PR называть по той же схеме: `rq1/...`, `rq3/...`, `rq4/...`.
